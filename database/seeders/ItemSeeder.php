...
class ItemSeeder extends Seeder
{
    ...
    public function run()
    {
        $items = [
            [
                'id' => 1,
                'name' => 'Sastha Necklace In 18K Yellow Gold With Akoya Pearls And Diamond',
            ...
            [
                'id' => 2,
                'name' => 'Sastha Necklace In 18K White Gold With Akoya Pearls And Diamond',
            ...
            [
                'id' => 3,
                'name' => 'Sastha Necklace In 18K Yellow Gold With Akoya Pearls, Diamond, Pink And Green Tourmaline',
            ...
            [
                'id' => 4,
                'name' => 'Sastha Ring In 18K Yellow Gold With Akoya Pearls And Diamond',
            ...
            [
                'id' => 6,
                'name' => 'Sastha Earrings In 18K Yellow Gold With Akoya Pearls And Diamond',
            ...
            [
                'id' => 7,
                'name' => 'Sastha Bracelet 18K Yellow Gold With Akoya Pearls And Diamond',
                'description' => 'Beautifully orchestrated, this Sastha bracelet in 18k yellow gold is inspired by musical notes',
                'price' => 3400,
                'image' => 'img8.png',
            ],
            [
                'id' => 8,
                'name' => 'Sastha Ring In 18K White Gold With Akoya Pearls And Blue Sapphires',
